...
flickrshow=function(l,i){var k,a,m;if(!this instanceof flickrshow)return new flickrshow(l,i);a=this;a.addEvent=function(b,d,e){if((b!=null?b.addEventListener:void 0)!=null)return b!=null?b.addEventListener(d,e,false):void 0;else if((b!=null?b.attachEvent:void 0)!=null){b["e"+d+e]=e;b[d+e]=function(){return b["e"+d+e](window.event)};return b!=null?b.attachEvent("on"+d,b[d+e]):void 0}};a.addUrl=function(){var b,d,e,f;d={api_key:"6cb7449543a9595800bc0c365223a4e8",extras:"url_s,url_m,url_z,url_l",format:"json",
jsoncallback:"flickrshow_jsonp_"+a.constants.random,page:a.settings.page,per_page:a.settings.per_page};if(a.settings.license!=null)d.license=a.settings.license;if(a.settings.gallery!=null){d.method="flickr.galleries.getPhotos";d.gallery_id=a.settings.gallery}else if(a.settings.group!=null){d.method="flickr.groups.pools.getPhotos";d.group_id=a.settings.group}else if(a.settings.set!=null){d.method="flickr.photosets.getPhotos";d.photoset_id=a.settings.set}else if(a.settings.person!=null){d.method="flickr.people.getPhotosOf";
d.user_id=a.settings.person}else if(a.settings.tags!=null||a.settings.user!=null){d.method="flickr.photos.search";if(a.settings.tags!=null)d.tags=a.settings.tags;if(a.settings.user!=null)d.user_id=a.settings.user}else d.method="flickr.photos.getRecent";e="http://api.flickr.com/services/rest/?";for(b in d)if(__hasProp.call(d,b)){f=d[b];e+=b+"="+f+"&"}return e};a.animate=function(b,d,e,f,g){var h;a.constants.intervals[g]!=null&&window.clearInterval(a.constants.intervals[g]);h=function(){var c,j;c=Math.round(b.style[d].replace(/([a-zA-Z]{2})$/,
""));j=Math.round(e-c);if(Math.abs(j)>1)return b.style[d]=Math.floor(c+j/2)+"px";else{b.style[d]=e+"px";return window.clearInterval(a.constants.intervals[g])}};return a.constants.intervals[g]=window.setInterval(h,f/1.5)};a.onClickLeft=function(){if(a.constants.isLoading!==true){a.constants.imageCurrent=a.constants.imageCurrent-1<0?a.constants.imageTotal-1:a.constants.imageCurrent-1;a.animate(a.elements.images,"left","-"+a.constants.imageCurrent*a.elements.target.offsetWidth,a.constants.speed,"i");
a.showTitle();if(typeof a.settings.onMove==="function")return a.settings.onMove(a.elements.images.childNodes[a.constants.imageCurrent].childNodes[0])}};a.onClickPlay=function(){var b;if(a.constants.isPlaying===false){a.constants.isPlaying=true;a.elements.buttons.childNodes[2].style.backgroundImage="url("+a.constants.base_url+"static/images/is.png)";b=function(){return a.onClickRight()};a.constants.intervals.playing=window.setInterval(b,a.settings.interval);if(typeof a.settings.onPlay==="function")return a.settings.onPlay()}else{a.constants.isPlaying=
false;a.elements.buttons.childNodes[2].style.backgroundImage="url("+a.constants.base_url+"static/images/ip.png)";window.clearInterval(a.constants.intervals.playing);if(typeof a.settings.onPause==="function")return a.settings.onPause(a.elements.images.childNodes[a.constants.imageCurrent].childNodes[0])}};a.onClickRight=function(){if(a.constants.isLoading!==true){a.constants.imageCurrent=a.constants.imageCurrent+2>a.constants.imageTotal?0:a.constants.imageCurrent+1;a.animate(a.elements.images,"left",
"-"+a.constants.imageCurrent*a.elements.target.offsetWidth,a.constants.speed,"i");a.showTitle();if(typeof a.settings.onMove==="function")return a.settings.onMove(a.elements.images.childNodes[a.constants.imageCurrent].childNodes[0])}};a.onLoadImage=function(b){var d,e,f,g;e=b.srcElement||b.target;b=e.offsetHeight;d=e.offsetWidth;if(d>b){g=Math.ceil(a.elements.target.offsetWidth+a.elements.target.offsetHeight/100);f=Math.ceil(g/d*b)}else{f=Math.ceil(a.elements.target.offsetHeight+a.elements.target.offsetHeight/
100);g=Math.ceil(f/b*d)}e.style.height=f+"px";e.style.left=Math.round((a.elements.target.offsetWidth-g)/2)+"px";e.style.position="absolute";e.style.top=Math.round((a.elements.target.offsetHeight-f)/2)+"px";e.style.width=g+"px";a.constants.imageLoaded+=1;b=Math.round(a.constants.imageLoaded/a.constants.imageTotal*240);a.animate(a.elements.loading.childNodes[0],"width",b<=36?36:b,"loading");if(a.constants.imageLoaded===a.constants.imageTotal){a.showTitle();a.elements.container.removeChild(a.elements.loading);
a.elements.images.style.visibility="visible";a.constants.isLoading=false;a.settings.autoplay===true&&a.onClickPlay();if(typeof a.settings.onLoad==="function")return a.settings.onLoad()}};a.onLoadJson=function(b){var d,e,f,g,h,c,j,q,n,o,p;a.elements.script.parentNode.removeChild(a.elements.script);if(b.photoset!=null){n=b.photoset.photo;h=0;for(j=n.length;h<j;h++){c=n[h];c.owner=b.photoset.owner}b.photos=b.photoset}if(b.stat!=null&&b.stat==="fail"||!b.photos)throw"Flickrshow: "+(b.message||"There was an unknown error with the data returned by Flickr");
a.constants.imageTotal=b.photos.photo.length;o=b.photos.photo;p=[];h=0;for(q=o.length;h<q;h++){c=o[h];b=document.createElement("img");b.setAttribute("data-flickr-title",c.title);b.setAttribute("data-flickr-photo_id",c.id);b.setAttribute("data-flickr-owner",c.owner);b.setAttribute("rel",h);b.style.cursor="pointer";b.style.display="block";b.style.margin="0";b.style.padding="0";f=a.elements.target.offsetHeight*a.elements.target.offsetWidth;g=c.height_z*c.width_z;d=c.height_m*c.width_m;e=c.height_s*c.width_s;
if(!c.url_m)c.url_m=c.url_s;if(!c.url_z)c.url_z=c.url_m;if(!c.url_l)c.url_l=c.url_z;b.src=f>g?c.url_l+"?"+a.constants.random:f>d?c.url_z+"?"+a.constants.random:f>e?c.url_m+"?"+a.constants.random:c.url_s+"?"+a.constants.random;c=document.createElement("li");c.style.left=h*a.elements.target.offsetWidth+"px";c.style.height=a.elements.target.offsetHeight+"px";c.style.margin="0";c.style.overflow="hidden";c.style.padding="0";c.style.position="absolute";c.style.top="0";c.style.width=a.elements.target.offsetWidth+
"px";c.appendChild(b);a.elements.images.appendChild(c);p.push(a.addEvent(b,"load",a.onLoadImage))}return p};a.onLoadWindow=function(){a.elements.target=typeof a.elements.target==="string"?document.getElementById(a.elements.target):a.elements.target;a.elements.target.innerHTML='<div class="flickrshow-container" style="background:transparent;height:'+a.elements.target.offsetHeight+"px;margin:0;overflow:hidden;padding:0;position:relative;width:"+a.elements.target.offsetWidth+'px"><div class="flickrshow-loading" style="background:transparent url('+
...
a.constants.random);return(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(a.elements.script)};a.hideButtons=function(){if(!(a.constants.isLoading===true||a.constants.isButtonsOpen===false)){a.constants.isButtonsOpen=false;return a.animate(a.elements.buttons,"top",a.elements.target.offsetHeight,a.constants.speed,"buttons")}};a.showButtons=function(){if(!(a.constants.isLoading===true||a.constants.isButtonsOpen===true)){a.constants.isButtonsOpen=true;
return a.animate(a.elements.buttons,"top",a.elements.target.offsetHeight-40,a.constants.speed,"buttons")}};a.toggleButtons=function(){return a.constants.isButtonsOpen===true?a.hideButtons():a.showButtons()};a.showFlickr=function(){var b;b=a.elements.images.childNodes[a.constants.imageCurrent].childNodes[0];if(b!=null)return window.location="http://www.flickr.com/photos/"+b.getAttribute("data-flickr-owner")+"/"+b.getAttribute("data-flickr-photo_id")+"/"};a.showTitle=function(){var b;b=a.elements.images.childNodes[a.constants.imageCurrent].childNodes[0];
if(b!=null)return a.elements.buttons.childNodes[3].innerHTML=a.constants.imageCurrent+1+"/"+a.constants.imageTotal+" - "+b.getAttribute("data-flickr-title")};a.constants={base_url:"http://www.flickrshow.com/",intervals:[],imageCurrent:0,imageLoaded:0,imageTotal:0,isButtonsOpen:false,isLoading:true,isPlaying:false,random:Math.floor(Math.random()*999999999999),speed:100};a.elements={buttons:null,button1:null,button2:null,button3:null,button4:null,container:null,images:null,loading:null,script:null,
target:null};a.settings={autoplay:false,gallery:null,group:null,hide_buttons:false,interval:3000,license:"1,2,3,4,5,6,7",onLoad:null,onMove:null,onPlay:null,onPause:null,page:"1",person:null,per_page:"50",set:null,tags:null,user:null};a.elements.target=l;m=a.settings;for(k in m)if(__hasProp.call(m,k))if(i[k]!=null)a.settings[k]=i[k];if(i.flickr_group!=null)a.settings.group=i.flickr_group;if(i.flickr_photoset!=null)a.settings.set=i.flickr_photoset;if(i.flickr_tags!=null)a.settings.tags=i.flickr_tags;
if(i.flickr_user!=null)a.settings.user=i.flickr_user;a.addEvent(window,"load",a.onLoadWindow);return{constants:a.constants,elements:a.elements,settings:a.settings,left:a.onClickLeft,right:a.onClickRight,play:a.onClickPlay}};if(window.jQuery!=null)window.jQuery.fn.flickrshow=function(l){return new flickrshow(window.jQuery(this)[0],l)};
